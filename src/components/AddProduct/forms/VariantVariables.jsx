...
const VariantVariables = ({
  ...
  const [priceViaColer, setPriceViaColer] = useState(false);
  const [priceViaSize, setPriceViaSize] = useState(false);

  useEffect(() => {
    priceViaColer && priceViaSize
      ? setPriceFlage('both')
      : priceViaColer & !priceViaSize
        ? setPriceFlage('color')
        : !priceViaColer & priceViaSize
          ? setPriceFlage('size')
          : setPriceFlage('product');
  }, [priceViaColer, priceViaSize]);
  useEffect(() => {
                  ...
                  control={
                    <Checkbox
                      onClick={(e) => {
                        ...
                        e.target.checked ? setPriceViaColer(true) : setPriceViaColer(false);
                  ...
                  control={
                    <Checkbox
                      onClick={(e) => {
                        ...
                        e.target.checked ? setPriceViaSize(true) : setPriceViaSize(false);
