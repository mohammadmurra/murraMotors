...
const Header = ({customerData, dateRage}) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography component='p' sx={{mb: 1}}>
            {customerData.phoneNumber.replace(/^970|^972/, '0')}
          </Typography>
          <Typography component='p' sx={{mb: 1}}>
            {customerData.email}
          </Typography>
        ...
        >
          ...
          <Typography component='p' sx={{mb: 1}}>
            <IntlMessages id='invoice.issued' />: {new Date().toDateString()}
          </Typography>
          <Typography component='p' sx={{mb: 1}}>
            <IntlMessages id='ReportStartDate.from' />:{' '}
            {new Date(dateRage[0]).toLocaleDateString()}
          </Typography>
          <Typography component='p' sx={{mb: 1}}>
            <IntlMessages id='ReportStartDate.to' />:{' '}
            {new Date(dateRage[1]).toLocaleDateString()}
          </Typography>
        </Box>
      </Box>
    </Box>
