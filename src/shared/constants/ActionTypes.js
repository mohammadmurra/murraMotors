...
export const GET_FINANCIAL_NOTIF_USERS='get_financial_notif_users';
//APP SETTING
...
export const SET_SearchFILTER_DATA = 'set_searchFilter_data';
...
export const GET_OLDEMPlOYEES = 'get_old_employees';
export const GET_RUNING_COST = 'get_runing_cost';
export const GET_TRANSACTION = 'get_transaction';
export const GET_CHECKS = 'get_checks';
export const GET_DELRUNING_COST = 'get_deleted_runing_cost';
export const GET_SALEPOINT = 'get_sale_point';
export const GET_COUPON = 'get_coupoon';
export const GET_OLDSALEPOINT = 'get_old_sale_point';
export const GET_AllMainCategories = 'GET_MainCategories';
//CK-EDITOR
